...
class ProductActions(CommonActions):
    ...
    def assert_product_elements(self):
        self.assert_element_is_visible(self.PRODUCT_IMAGE)
        self.assert_element_is_visible(self.FINAL_PRICE)
        self.assert_element_is_visible(self.QUANTITY_FIELD)
    ...
    def assert_original_price_presence(self):
        self.assert_element_is_visible(self.ORIGINAL_PRICE)
    ...
    def assert_cover_selector_presence(self):
        self.assert_element_is_visible(self.COVER_SELECTOR)
