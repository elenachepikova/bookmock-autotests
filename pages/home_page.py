...
class HomePage(CommonActions):
    ...
    def assert_page_is_displayed(self):
        ...
        self.assert_text(self.BANNER_TITLE, self.BANNER_NAME)
    ...
    def assert_sections_are_present(self):
        ...
        self.assert_text(self.BANNER_TITLE, self.BANNER_NAME)
        self.assert_text(self.FEATURED_SECTION_TITLE, self.FEATURED_NAME)
        self.assert_text(self.RECENT_REVIEWS_TITLE, self.RECENT_REVIEWS_NAME)
