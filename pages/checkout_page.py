...
class CheckoutPage(CommonActions):
    ...
    def __init__(self, driver):
        ...
        self.page = "https://checkout-qmrd57hz.websiteserver4.com/_storeManager.checkout"
    ...
    def select_country(self):
        self.select_dropdown_option(self.COUNTRY_SELECTOR, "BY")

    def select_state(self):
        self.select_dropdown_option(self.STATE_SELECTOR, "MI")

    @allure.step('Fill in and submit "Checkout" form')
    def fill_in_checkout_form(self):
        self.insert_text("abc@example.com", self.EMAIL_FIELD)
        self.insert_text("ABC", self.FIRST_NAME_FIELD)
        self.insert_text("ABC", self.LAST_NAME_FIELD)
        self.insert_text("ABC", self.ADDRESS_FIELD_1)
        self.insert_text("ABC", self.CITY_FIELD)
        self.select_country()
